...
$Ad_slider1 = TableRegistry::get('Ad_slider2');
...
$url = "http://".$_SERVER['SERVER_NAME']."/";
$title = file_get_contents($url."/globals/title_kz.txt");
...
?>
            ...
            <div class="one-third">
                ...
                <div class="box">
                    ...
                    <div class="long_space"></div>
                        ...
                        <?= file_get_contents($url."/globals/contacts_kz.txt"); ?>
                ...
                <div class="box">
                    <a href="/kz/medser/price/?search=" title="Медицинкалық қызметтерге арналған бағалар" alt="Медицинкалық қызметтерге арналған бағалар"><img class="cost" src="/images/invoice.svg" alt="image" tile="image" /></a>

                    <a href="/kz/medser/price/?search=" title="Медицинкалық қызметтерге арналған бағалар" alt="Медицинкалық қызметтерге арналған бағалар"><h4>Медицинкалық қызметтерге арналған бағалар</h4></a>
                ...
                <div class="box">
                    ...
                    <div class="new">
                        <article>
                            <h6><a href="news/page?id=<?= $new->id ?>"><?= $new->title_kz ?></a></h6>
                            <div class="date"> 
                                <time><span><?= $new->date ?></span></time>
                            </div>                            
							<div class="my-newbox"><?= strip_tags(mb_substr($new->text_kz, 0,280,'UTF-8'))."..." ?></div>
                        </article> 
                    </div>
                    <?php endforeach; ?>
                    ...
                    <div class="show-more">
                       <a href="news/"> Жаңалықтар бөлімін ашу <img class="next" src="/images/next.svg"></a>
                    </div>               
                ...
                <div class="box">
                    <h4>Аурухананың басшысы</h4>
                    <img class="cost" src="/uploads/fm/images/photo.jpg">
                    <h3>Джувашев Алмаз Болатович</h3>

                    <div class="small_space"></div>

                    <h6><a href="/kz/page?id=3" title="Өмірбаян" alt="Өмірбаян">Өмірбаян</a> &nbsp; | &nbsp; <a href="/ru/page?id=25" title="Сұрақ қою" alt="Сұрақ қою">Сұрақ қою</a></h6>
    ...
    <div class="row bvi-hide">
        ...
        <div id="Carousel" class="carousel slide hide-in-mobile">
                ...
                ?>                                   
                    <a href="<?= $slide3->link_kz ?>" title = "<?= $slide3->text_kz ?>">
	...
	(function(d, s, id) {
	  ...
	  js.src = 'https://connect.facebook.net/ru_kz/sdk.js#xfbml=1&version=v2.12';
