...
$keys = file_get_contents($url."/globals/keywords_kz.txt");
$desc = file_get_contents($url."/globals/description_kz.txt");
...
echo file_get_contents($url."/globals/header_kz.txt");
