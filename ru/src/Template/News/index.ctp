...
<div class="main-block">
            ...
            <div class="one-whole">
                ...
                <div class="box">
                    ...
                    <span><a href="/ru/">Главная</a> / <a href="/ru/news/">Новости</a> </span>
                ...
                <div class="box my-news">
                    ...
                    <div class="news-box">
                        ...
                        <data><?= $new->date ?></data>
                        <h5><a href="page?id=<?= $new->id ?>"><?= $new->title_ru ?></a></h5>
                    	 
                        	
-                           <div class="my-newprev"> <? $clear = trim(preg_replace('/ +/', ' ', urldecode(html_entity_decode(strip_tags(mb_substr($new->text_ru, 0,10000,'UTF-8')."..."))))) ?></div>
